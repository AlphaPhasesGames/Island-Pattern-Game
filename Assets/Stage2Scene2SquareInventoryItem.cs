...
{
    public class Stage2Scene2SquareInventoryItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public Button squareButton; // this button holds the image for the gold item when in inventory
        ...
        public Stage2Scene2DiamondInvItem diamondInvItemScript;
        // Start is called before the first frame update
        private void Start()
        {
            //digiWaveMain = FindObjectOfType<TUSOMMain>();
            squareButton.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        public void SelectSphereItem() // gold fucntion for mouse click
        {
            ...
            diamondInvItemScript.DeSelectSphereItem();
