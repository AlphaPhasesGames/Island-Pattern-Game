...
{
    public class StageScene2Circle3InvItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI circle3Name; //TMP text to appear at bottom of inv for gold item
        ...
        public Button circle3Button; // this button holds the image for the gold item when in inventory
        ...
        private void Start()
        {
            ...
            circle3Button.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        void Update()
        {
            if (playerPickedUpObject) // if player has picked up the gold item
            {
                ...
                circle3Button.gameObject.SetActive(false);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            circle3Name.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            circle3Name.gameObject.SetActive(false); // hide text for gold item
        ...
        public void DeSelectSphereItem() // gold fucntion for mouse click
        {
            if (playerPickedUpObject)
            {
                ...
                circle3Button.gameObject.SetActive(true);
                circle3Held = false;
                circle3Name.gameObject.SetActive(false); // show text for gold item
