...
{
    public class Stage2Scene2Hexagon3InvItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI hexagon3Name; //TMP text to appear at bottom of inv for gold item
        ...
        public Button hexagon3Button; // this button holds the image for the gold item when in inventory
        ...
        public bool hexagon3Held;

        // Start is called before the first frame update
        private void Start()
        {
            //digiWaveMain = FindObjectOfType<TUSOMMain>();
            hexagon3Button.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        void Update()
        {
            if (playerPickedUpObject) // if player has picked up the gold item
            {
                ...
                hexagon3Button.gameObject.SetActive(false);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            hexagon3Name.gameObject.SetActive(true); // show text for gold item
