...
{
    public class Stage2Scene2DiamondInvItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI diamond1Name; //TMP text to appear at bottom of inv for gold item
        ...
        public Button diamond1Button; // this button holds the image for the gold item when in inventory
        ...
        public bool diamond1Held;
        public Stage2Scene2SquareInventoryItem square1ItemScript;
        public Stage2Scene2Hexagon1InvItem hex2ItemsScript;
        // Start is called before the first frame update
        private void Start()
        {
            //digiWaveMain = FindObjectOfType<TUSOMMain>();
            diamond1Button.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        void Update()
        {
            if (playerPickedUpObject) // if player has picked up the gold item
            {
             ...
             //   diamond1Button.gameObject.SetActive(false);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            diamond1Name.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            diamond1Name.gameObject.SetActive(false); // hide text for gold item
        ...
        public void DeSelectSphereItem() // gold fucntion for mouse click
        {
            if (playerPickedUpObject)
            {
                ...
                invItemImage.gameObject.SetActive(false); // this enables the image of the game obect to be held
                playerHasBadgeObject = false;
                diamond1Button.gameObject.SetActive(true);
                diamond1Held = false;
                diamond1Name.gameObject.SetActive(false); // hide text for gold item
