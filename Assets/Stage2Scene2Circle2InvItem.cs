...
{
    public class Stage2Scene2Circle2InvItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI circle2Name; //TMP text to appear at bottom of inv for gold item
        ...
        public Button circle2Button; // this button holds the image for the gold item when in inventory
        ...
        public bool circle2Held;

        // Start is called before the first frame update
        private void Start()
        {
            //digiWaveMain = FindObjectOfType<TUSOMMain>();
            circle2Button.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        void Update()
        {
            if (playerPickedUpObject) // if player has picked up the gold item
            {
                ...
                circle2Button.gameObject.SetActive(false);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            circle2Name.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            circle2Name.gameObject.SetActive(false); // hide text for gold item
