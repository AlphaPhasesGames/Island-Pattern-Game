...
{
    public class Stage1Scene1Number11InvProperties : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public Stage1Scene1Number4InvProperties no4Prop;
