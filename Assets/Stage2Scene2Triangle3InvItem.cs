...
{
    public class Stage2Scene2Triangle3InvItem : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public TextMeshProUGUI triangle3Name; //TMP text to appear at bottom of inv for gold item
        ...
        public Button triangle3Button; // this button holds the image for the gold item when in inventory
        ...
        public bool triangle3Held;

        // Start is called before the first frame update
        private void Start()
        {
            //digiWaveMain = FindObjectOfType<TUSOMMain>();
            triangle3Button.onClick.AddListener(TurnOnAndOff); // add listener to button for gold item
        }
        ...
        void Update()
        {
            if (playerPickedUpObject) // if player has picked up the gold item
            {
                ...
                triangle3Button.gameObject.SetActive(false);
            }
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            triangle3Name.gameObject.SetActive(true); // show text for gold item
            Debug.Log("Mouse is over GameObject.");
        }
        public void OnPointerExit(PointerEventData eventData)
        {
            //If your mouse hovers over the GameObject with the script attached, output this message and execute code
            triangle3Name.gameObject.SetActive(false); // hide text for gold item
